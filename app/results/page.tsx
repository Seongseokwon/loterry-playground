...
export default async function ResultsPage() {
  ...
  return (
    <div className="page page-narrow">
      <header className="page-header"><p className="eyebrow">전체 {draws.length.toLocaleString("ko-KR")}개 회차</p><h1>당첨번호</h1><p className="body-color">제{oldestDraw.round}회부터 제{latestDraw.round}회까지 실제 추첨 결과를 보여드려요.</p></header>
